...
func printOneliner1() {
	...
	txt := textClr.Sprintf("      by OFFICIAL_cyber_satyam27 (") + handleClr.Sprintf("@SRY") + textClr.Sprintf(")") + spc + textClr.Sprintf("version ") + versionClr.Sprintf("%s", VERSION)
	fmt.Fprintf(color.Output, "%s", txt)
}
...
func Banner() {
	...
	putAsciiArt("__                                     __\n")
	putAsciiArt("_   @@     @@@@@@@@@@@@@@@@@@@     @@   _")
	printLogo(`    ____  ___      ________ __         __           `)
	fmt.Println()
	putAsciiArt("  @@@@    @@@@@@@@@@@@@@@@@@@@@    @@@@  ")
	printLogo(`   / __ \ / _ \    / ____/ //_/__  ___/ /__  _____`)
	fmt.Println()
	putAsciiArt("  @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@  ")
	printLogo(`  / /_/ //  __/   / __/  / ,< / _ \/ / / / / / _ \`)
	fmt.Println()
	putAsciiArt("    @@@@@@@@@@###@@@@@@@###@@@@@@@@@@    ")
	printLogo(` / _, _/ \___/   /_/    /_/|_/_//_/_/_/\_,_/_//_/`)
	fmt.Println()
	putAsciiArt("      @@@@@@@#####@@@@@#####@@@@@@@      ")
	printLogo(`              J A C K   T H E   E V I L H E L P E R`)
	fmt.Println()
	putAsciiArt("       @@@@@@@###@@@@@@@###@@@@@@@       ")
	printLogo(`                         S R Y`)
	fmt.Println()
